...
public class UsersPageControllerTest extends ApplicationTest {
	...
	public void start(Stage stage) throws Exception {
		FXMLLoader loader = new FXMLLoader(
				getClass().getResource("/com/carrental/ui/views/dashboards/AdminDashboard/Users.fxml"));
	...
	void testShowUserFormHandlesNull() {
		assertDoesNotThrow(() -> {
			...
			controller.getUserTable().setItems(FXCollections.observableArrayList(List.of(new User(999, "Test User",
					"test@example.com", "Admin", "1234567890", Timestamp.valueOf(LocalDateTime.now())))));
			interact(() -> controller.initialize());
		});
	}
}
