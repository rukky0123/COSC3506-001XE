...
import com.carrental.controllers.dashboards.AdminDashboard.components.CarFormDialogController;
...
public class CarsPageController {
    ...
    private void showCarForm(Car existingCar) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/carrental/ui/views/dashboards/AdminDashboard/components/CarFormDialog.fxml"));
            DialogPane dialogPane = loader.load();

            CarFormDialogController controller = loader.getController();
