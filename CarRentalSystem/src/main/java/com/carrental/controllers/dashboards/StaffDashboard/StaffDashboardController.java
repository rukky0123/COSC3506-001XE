...
import com.carrental.controllers.dashboards.StaffDashboard.components.NavbarController;
	...
	public void initialize() {
		try {
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/com/carrental/ui/views/dashboards/StaffDashboard/components/Navbar.fxml"));
