...
import com.carrental.controllers.dashboards.StaffDashboard.components.Booking_listFormDialogController;
...
public class Booking_listController {
    ...
    private void showBookingForm(Booking existingBooking) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/carrental/ui/views/dashboards/StaffDashboard/components/Booking_Form.fxml"));
            DialogPane dialogPane = loader.load();

            Booking_listFormDialogController controller = loader.getController();
