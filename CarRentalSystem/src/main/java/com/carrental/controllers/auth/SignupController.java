...
public class SignupController {
	...
	@FXML
	public TextField firstNameField, lastNameField, emailField, confirmEmailField;
	@FXML
	public PasswordField passwordField, confirmPasswordField;
	@FXML
	public TextField address1Field, address2Field, cityField, provinceField, postalCodeField, countryField;
	@FXML
	public TextField cardNameField, cardNumberField, expMonthField, expYearField, securityCodeField, cardPostalField,
			cardCountryField;

	@FXML
	public Label errorUsername, errorFirstName, errorLastName, errorEmail, errorConfirmEmail;
	@FXML
	public Label errorPassword, errorConfirmPassword, errorAddress1, errorCity;
	@FXML
	public Label errorProvince, errorZip, errorCountry;
	@FXML
	public Label errorCardName, errorCardNumber, errorExp, errorCvv, errorCardZip, errorCardCountry;
